...
import com.icthh.xm.tmf.ms.customer.service.ExampleEntitySecondQueryService;
import com.icthh.xm.tmf.ms.customer.service.ExampleEntitySecondService;
import com.icthh.xm.tmf.ms.customer.service.criteria.ExampleEntitySecondCriteria;
import com.icthh.xm.tmf.ms.customer.service.dto.ExampleEntitySecondDto;
import com.icthh.xm.tmf.ms.customer.web.rest.errors.BadRequestAlertException;
import com.icthh.xm.tmf.ms.customer.web.rest.utils.ResponseContentUtils;
import java.net.URI;
...
/**
 * REST controller for managing {@link ExampleEntitySecond}.
 */
@Slf4j
@RestController
@RequestMapping("/api")
...
public class ExampleEntitySecondResource {
    ...
    private static final String ENTITY_NAME = "tmf.ms.customerExampleEntitySecond";
