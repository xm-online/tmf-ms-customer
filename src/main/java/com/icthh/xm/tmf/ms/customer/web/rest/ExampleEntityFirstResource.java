...
import com.icthh.xm.tmf.ms.customer.service.ExampleEntityFirstQueryService;
import com.icthh.xm.tmf.ms.customer.service.ExampleEntityFirstService;
import com.icthh.xm.tmf.ms.customer.service.criteria.ExampleEntityFirstCriteria;
...
/**
 * REST controller for managing {@link ExampleEntityFirst}.
 */
@Slf4j
@RestController
@RequestMapping("/api")
...
public class ExampleEntityFirstResource {
    ...
    private static final String ENTITY_NAME = "tmf.ms.customerExampleEntityFirst";
