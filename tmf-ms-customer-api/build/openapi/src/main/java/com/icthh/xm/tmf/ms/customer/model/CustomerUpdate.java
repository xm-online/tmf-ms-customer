...
@Schema(name = "Customer_Update", description = " Skipped properties: id,href,id,href")
...
public class CustomerUpdate   {
  ...
  */
  ...
  @Schema(name = "name", description = "A word, term, or phrase by which the PartyRole is known and distinguished from other PartyRoles.", required = false)
